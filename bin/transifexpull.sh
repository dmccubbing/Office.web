...
for file in $PWD/../lib/Office.web/localization/*/*.inc; do
    do_clean $file
done
...
for file in $PWD/../lib/Office.web/localization/*/labels.inc; do grep -q -E '\$labels' $file || rm $file; done
for file in $PWD/../lib/Office.web/localization/*/messages.inc; do grep -q -E '\$messages' $file || rm $file; done
