...
function rcube_webmail()
{
  ...
  this.env = {
    ...
    comm_path: './',
    blankpage: 'lib/Office.web/resources/blank.gif',
  ...
  this.async_upload_form = function(form, action, onload)
  {
    ...
    if (document.all) {
      document.body.insertAdjacentHTML('BeforeEnd', '<iframe name="'+frame_name+'"'
        + ' src="lib/Office.web/resources/blank.gif" style="width:0;height:0;visibility:hidden;"></iframe>');
  ...
  this.tif_support_check = function()
  {
    ...
    img.src = 'lib/Office.web/resources/blank.tif';
  };
