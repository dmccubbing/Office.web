...
class MailFunc extends PHPUnit_Framework_TestCase
{
    ...
    function test_html()
    {
        ...
        $this->assertRegExp('#background="./lib/Office.web/resources/blocked.gif"#', $html, "Replace external background image");
    ...
    function test_washtml_utf8()
    {
        ...
        $this->assertRegExp('/<p>������������<\/p>/', $washed, "Remove non-unicode characters from HTML message body");
    }
